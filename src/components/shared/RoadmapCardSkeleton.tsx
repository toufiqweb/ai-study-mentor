export default function RoadmapCardSkeleton() {
  return (
    <div className="flex h-full flex-col rounded-3xl border border-(--border-subtle) bg-(--surface) p-6 shadow-sm">
      ...
      <div className="mt-3 h-4 w-3/4 animate-pulse rounded bg-(--surface-subtle)" />
      ...
      <div className="mt-4 h-3 w-2/3 animate-pulse rounded bg-(--surface-subtle)" />
      <div className="mt-5 h-10 w-full animate-pulse rounded-xl bg-(--surface-subtle)" />
    </div>
  );
}
